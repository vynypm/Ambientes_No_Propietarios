<?php
	include ('php/conexion_index.php');
	echo '<html>';
	...
	echo '<body>';
		echo '<form action="php/conexion_index.php" method="POST">';
		echo '<div id="parte1">';
			...
			echo '<article id="registro">';
				...
				echo ' ';
				echo '<input type="password" id="contra" placeholder="contraseña"></input>';
				echo ' ';				
				echo '<input class="btningresar" type="submit" value="Ingresar">';			
				echo ' ';
				echo ' ';
				echo'<a href="registro.php"><input class="btnregistrarme" type="submit" value="Registrar" ></a>';
			echo '</article>';
		echo '</div>';
