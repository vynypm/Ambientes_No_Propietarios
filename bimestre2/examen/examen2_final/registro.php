...
<body>
	...
	<div class = "container">
		<h1 class="text-primary col-md-offset-3">Registrate para poder matricularte</h1>
    <br><br>
		<div class = "row">
        	...
        	<div>
          	<center><button type="button" class="btn btn-primary" id="registrarme" >Registrarme</button>
          	<button type="button" class="btn btn-primary" id="cancelar" >Cancelar</button></center>
        	</div>
